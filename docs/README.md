...
**Références visuelles choisies le 21 septembre 2026 :** le propriétaire demande de préserver la DA de UNO et Géographie et d'harmoniser les sept autres jeux avec elle. Précision du 22 septembre : alléger les neuf interfaces et faire tenir le plateau dans la fenêtre ; scores secondaires et détails accessibles à la demande, sans changer les assets/palettes des références. Fond violet nuit, panneaux translucides, accents pastel et contrôles lisibles remplacent la base crème/verte provisoire des parties. Les nouvelles déclinaisons restent à apprécier par le propriétaire ; la validation des références n'est pas une validation automatique de chaque écran.
